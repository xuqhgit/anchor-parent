...
import com.anchor.ms.core.shiro.CustomShiroSessionDAO;
...
//		}
	...
	public List<SimplePrincipalCollection> getSimplePrincipalCollectionByUserId(Long...userIds){
		//把userIds 转成Set，好判断
		Set<Long> idset = (Set<Long>) com.anchor.ms.common.utils.StringUtils.array2Set(userIds);
		//获取所有session
		Collection<Session> sessions = customShiroSessionDAO.getActiveSessions();
		//定义返回
	...
	public Object getSession(String sessionId) {
		...
		Object bo = getSessionBo(session);
		return bo;
	}
	private Object getSessionBo(Session session){
		//获取session登录信息。
		Object obj = session.getAttribute(DefaultSubjectContext.PRINCIPALS_SESSION_KEY);
		if(null == obj){
			return null;
